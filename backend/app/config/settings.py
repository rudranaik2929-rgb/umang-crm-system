...
HOUSING_POLL_INITIAL_WINDOW_SEC = int(os.environ.get("HOUSING_POLL_INITIAL_WINDOW_SEC", "21600"))
HOUSING_POLL_OVERLAP_SEC = int(os.environ.get("HOUSING_POLL_OVERLAP_SEC", "21600"))
HOUSING_POLL_MIN_WINDOW_SEC = int(os.environ.get("HOUSING_POLL_MIN_WINDOW_SEC", "21600"))
